...
import { httpAshwinRepoTest0204 } from '../src/functions/index';

describe('httpAshwinRepoTest0204 function', () => {
  ...
  it('should return "Hello, world!" when no name is provided', async () => {
    const result = await httpAshwinRepoTest0204(mockRequest as any, mockContext as any);
  ...
  it('should return "Hello, Bob!" when the name is provided in the body', async () => {
    ...
    const result = await httpAshwinRepoTest0204(mockRequest as HttpRequest, mockContext as InvocationContext);
